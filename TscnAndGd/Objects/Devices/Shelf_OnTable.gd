		...
		- 1:
			...
			if LayerA_Obj:
				...
				if LayerA_Obj.FuncType in ["Can"]:
					if LayerA_Obj.FuncTypePara in ["糖渍樱桃"]:
						if _Dev.get("Condiment_1") == "":
							A_bool = true
					else:
						match _Dev.TYPE:
			...
			if LayerB_Obj:
				...
				if LayerB_Obj.FuncType in ["Can"]:
					...
					if LayerB_Obj.FuncTypePara in ["糖渍樱桃"]:
						if _Dev.get("Condiment_1") == "":
							B_bool = true
					else:
						match _Dev.TYPE:
			...
			if LayerX_Obj:
				...
				if LayerX_Obj.FuncType in ["Can"]:
					if LayerX_Obj.FuncTypePara in ["糖渍樱桃"]:
						if _Dev.get("Condiment_1") == "":
							X_bool = true
					else:
						match _Dev.TYPE:
			...
			if LayerY_Obj:
				...
				if LayerY_Obj.FuncType in ["Can"]:
					if LayerY_Obj.FuncTypePara in ["糖渍樱桃"]:
						if _Dev.get("Condiment_1") == "":
							Y_bool = true
					else:
						match _Dev.TYPE:
